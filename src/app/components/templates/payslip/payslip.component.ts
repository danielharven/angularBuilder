...
export class PayslipComponent implements OnInit {
  ...
  details={
    paymentMonth: "", taxableIncome: undefined, pensionToDate: undefined,
    leaveTaken: undefined, orgUnit: undefined, leaveAccrued: undefined,
    costCenterName: undefined, costCenter: undefined, bankKey: undefined,
    bankBranch: undefined, ministry: undefined, district: undefined,
    position: undefined, bankName: undefined, empName: undefined,
    scale: undefined, nrc: undefined, empNo: undefined, empGroup: undefined,
    presentAppointmentDate: undefined, nxtAppraisalDate: undefined, manNo: undefined,
  ...
  //
    this.transactions.forEach(ele=>{
      let dedu = parseFloat(ele.deductionAmount.replace(/,/g,''))||0;
      let paym = parseFloat(ele.paymentAmount.replace(/,/g,''))||0;
      this.netDeduc+=dedu;
      this.netPay+= paym;
